...
telltale implements **[Binoculars](https://arxiv.org/abs/2401.12070)** (Hans et
...
On top of the document score, telltale re-aggregates the same per-token
...
```bash
git clone https://github.com/roowus/telltale && cd telltale
...
- Short texts (< ~50 tokens) cannot be reliably scored; telltale says so
